...
`;var Pe=Object.defineProperty,Me=Object.getOwnPropertyDescriptor,bt=(r,t,e,i)=>{for(var s=i>1?void 0:i?Me(t,e):t,o=r.length-1,n;o>=0;o--)(n=r[o])&&(s=(i?n(t,e,s):n(s))||s);return i&&s&&Pe(t,e,s),s};let B=class extends b{constructor(){super(...arguments),this.dropped=!1,this.expand=!1}render(){return g`
      <button class="normal"
  ...
  .mode-name {
    ...
    margin-left: .4rem;
    transition: color .3s;
  }`,vt,it];yt([p({type:Boolean,reflect:!0})],I.prototype,"expand",2);yt([mt()],I.prototype,"themeName",2);I=yt([A("theme-toggle")],I);function De(r,t){let e=null;return function(...i){e&&clearTimeout(e),e=setTimeout(()=>r(...i),t)}}var Be=Object.defineProperty,Le=Object.getOwnPropertyDescriptor,Qt=(r,t,e,i)=>{for(var s=i>1?void 0:i?Le(t,e):t,o=r.length-1,n;o>=0;o--)(n=r[o])&&(s=(i?n(t,e,s):n(s))||s);return i&&s&&Be(t,e,s),s};let et=class extends b{constructor(){super(...arguments),this.showResult=!1,this.inputRef=X(),this.debouncedInputHandler=De(()=>{const r=/^[\p{Script=Han}\p{Script=Hiragana}\p{Script=Katakana}]+$/u,t=this.inputRef.value.value;r.test(t)&&this.dispatchEvent(new Yt(t))},100)}clear(){this.inputRef.value.value="",this.dispatchEvent(new CustomEvent("clear"))}render(){return g`
      <div class="container">
        <div class="logo">
          <img src="/favicon.svg" />
        </div>
  ...
  `}function Ot(r){const t=Ft(r);return $t(r,t)}function Ke(r){const t=/\[([^\|]+)\|([^\]]+)\]/g;return r.replace(t,(i,s,o)=>$t(s,o.split("|").join("")))}var Qe=Object.defineProperty,Fe=Object.getOwnPropertyDescriptor,y=(r,t,e,i)=>{for(var s=i>1?void 0:i?Fe(t,e):t,o=r.length-1,n;o>=0;o--)(n=r[o])&&(s=(i?n(t,e,s):n(s))||s);return i&&s&&Qe(t,e,s),s};const Rt=null;let _=class extends b{constructor(){super(...arguments),this.character="",this.showMoreUsage=!1,this.showMoreSentence=!1,this.hiraganaMode=!1,this.romajiMode=!1,this.loadCharData=new Ve(this,{task:async([r],{signal:t})=>{const e=await fetch(`/characters/${r}.json`,{signal:t});if(!e.ok)throw new Error(`Character data loading error: ${e.status}.`);return await e.json()},args:()=>[this.character]})}copyCharacter(){navigator.clipboard.writeText(this.character)}render(){return g`
      <div class="char-info">
        ...
        <div class="informations">
          ${this.loadCharData.render({pending:()=>g`<p>加载中...</p>`,complete:r=>{const t="無",e="、",i=a=>`<span>${a}</span>`;let s=t,o=t;r.on&&(this.hiraganaMode?s=r.on.map(i).join(e):s=r.on.map(Ot).join(e)),r.kun&&(this.hiraganaMode?o=r.on.map(i).join(e):o=r.on.map(Ot).join(e)),s=Y(s),o=Y(o);let n=t;r.usages&&(n=Y(r.usages.map(({slug:a,japanese:[{reading:c}]})=>{const d=this.hiraganaMode?c:Ft(c);return`
